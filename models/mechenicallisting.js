...
const MechenicalListingSchema = new Schema({
  image: { 
    url: {
      type: String,
...
const MechenicalListing = mongoose.model("MechenicalListing", MechenicalListingSchema);
module.exports = MechenicalListing;
