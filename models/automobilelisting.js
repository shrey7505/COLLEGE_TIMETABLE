...
const AutomobileListingSchema = new Schema({
  image: { 
    url: {
      type: String,
...
const AutomobileListing = mongoose.model("AutomobileListing", AutomobileListingSchema);
module.exports = AutomobileListing;
