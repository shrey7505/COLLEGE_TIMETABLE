...
const ElectricalListingSchema = new Schema({
  image: { 
    url: {
      type: String,
...
const ElectricalListing = mongoose.model("ElectricalListing", ElectricalListingSchema);
module.exports = ElectricalListing;
